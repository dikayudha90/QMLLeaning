...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(944, 695);
        QIcon icon;
        ...
        tab_manager->addTab(Page, QString());
        imageTab = new QWidget();
        imageTab->setObjectName(QString::fromUtf8("imageTab"));
        imageTab->setEnabled(true);
        imageTab->setFocusPolicy(Qt::TabFocus);
        imageTab->setAutoFillBackground(true);
        lblOriginal = new QLabel(imageTab);
        lblOriginal->setObjectName(QString::fromUtf8("lblOriginal"));
        lblOriginal->setGeometry(QRect(0, 0, 640, 480));
        tab_manager->addTab(imageTab, QString());
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        tab_manager->setTabText(tab_manager->indexOf(Page), QApplication::translate("MainWindowDesign", "Page", 0, QApplication::UnicodeUTF8));
        lblOriginal->setText(QApplication::translate("MainWindowDesign", "TextLabel", 0, QApplication::UnicodeUTF8));
        tab_manager->setTabText(tab_manager->indexOf(imageTab), QApplication::translate("MainWindowDesign", "Camera View", 0, QApplication::UnicodeUTF8));
